...
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_sys_gloss_tuning_kegg_oct23_2024.pickle', 'rb') as handle:
    kegg_g_cv = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_sys_gloss_tuning_hallmark_oct23_2024.pickle', 'rb') as handle:
