...
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_ln_gloss_tuning_kegg_oct23_2024.pickle', 'rb') as handle:
    kegg_g_cv = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_ln_gloss_tuning_hallmark_oct23_2024.pickle', 'rb') as handle:
    hallmark_g_cv = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/gloss_lasso_tuning_lcmv_ln_oct23_2024.pickle', 'rb') as handle:
    lasso_dict = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/gloss_elasticnet_tuning_lcmv_ln_oct23_2024.pickle', 'rb') as handle:
    enet_dict = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/gloss_ridge_tuning_lcmv_ln_oct23_2024.pickle', 'rb') as handle:
...
with open('./experiment_evaluations/model_arena_ln_oct23_2024.pickle', 'wb') as handle:
