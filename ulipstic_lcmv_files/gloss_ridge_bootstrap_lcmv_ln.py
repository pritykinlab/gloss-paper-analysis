...
with open('./experiment_evaluations/gloss_ridge_tuning_lcmv_ln_oct23_2024.pickle', 'rb') as handle:
...
with open('./experiment_evaluations/gloss_ridge_bootstrap_lcmv_ln_oct23_2024.pickle', 'wb') as handle:
