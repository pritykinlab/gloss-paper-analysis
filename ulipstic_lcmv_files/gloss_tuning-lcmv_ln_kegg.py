...
regcv = RegressCV(datapath, resolutions, 'kegg', 
                  ...
                  group_regs = [0.005, 0.006, 0.007, 0.008], single_gene_regs=[1,2,3,4,5], donors_profiled=True)

savepath = './experiment_evaluations/lcmv_ln_new_gloss_tuning_kegg_oct24_2024.pickle'
