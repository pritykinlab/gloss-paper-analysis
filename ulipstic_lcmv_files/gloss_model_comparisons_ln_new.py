...
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_ln_new_gloss_tuning_kegg_oct24_2024.pickle', 'rb') as handle:
    kegg_g_cv = pickle.load(handle)
    
with open('../model_ulipstic_lcmv/experiment_evaluations/lcmv_ln_new_gloss_tuning_hallmark_oct24_2024.pickle', 'rb') as handle:
...
with open('./experiment_evaluations/model_arena_new_ln_oct24_2024.pickle', 'wb') as handle:
