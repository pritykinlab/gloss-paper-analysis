...
regcvpath = './experiment_evaluations/gut_new_gloss_tuning_kegg_oct24_2024.pickle'
with open(regcvpath, 'rb') as handle:
    myregcv = pickle.load(handle)

regb = RegressBootstrap(gutpath, resolutions, 'kegg', myregcv.best_params, 100,
                  'avg_sample_hto', 'total_counts', 'raw_biotin')

savepath = './experiment_evaluations/gut_new_gloss_bootstrap_kegg_oct24_2024.pickle'
