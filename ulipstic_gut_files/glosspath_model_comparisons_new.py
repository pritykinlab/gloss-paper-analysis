...
with open('./experiment_evaluations/gut_new_gloss_tuning_kegg_oct24_2024.pickle', 'rb') as handle:
    kegg_g_cv = pickle.load(handle)
    
with open('./experiment_evaluations/gut_new_gloss_tuning_hallmark_oct24_2024.pickle', 'rb') as handle:
