...
gutpath = '../joint_notebooks/datasets/{}_gut_data_perturbed_combined_c_n_relaxed_6_v2_oct_26_2024.h5ad'.format(i)
...
savepath = './experiment_evaluations/{}_gut_perturbed_relaxed_6_new_gloss_bootstrap_hallmark_oct26_2024.pickle'.format(i)
