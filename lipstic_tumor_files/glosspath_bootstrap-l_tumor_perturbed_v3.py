...
datapath = '../joint_notebooks/datasets/{}_lipstic_tumor_data_perturbed_filtered_binned_v3_oct_25_2024.h5ad'.format(i)
...
savepath = './experiment_evaluations/{}_tumor_perturbed_filtered_binned_v3_new_gloss_bootstrap_hallmark_oct25_2024.pickle'.format(i)
