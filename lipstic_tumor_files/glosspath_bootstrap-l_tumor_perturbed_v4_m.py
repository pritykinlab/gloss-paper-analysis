...
datapath = '../joint_notebooks/datasets/{}_lipstic_tumor_data_perturbed_v4_m_oct_21_2024.h5ad'.format(i)
...
savepath = './experiment_evaluations/{}_tumor_perturbed_v4_m_new_gloss_bootstrap_hallmark_oct24_2024.pickle'.format(i)
