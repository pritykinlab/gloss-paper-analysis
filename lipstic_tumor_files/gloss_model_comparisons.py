...
prepped_data_kegg = PrepData(datapath, 'kegg', 'hash_max', 'nCount_RNA', 'biotin_raw')

with open('./experiment_evaluations/tumor_glosspath_tuning_kegg_oct9_2024.pickle', 'rb') as handle:
    kegg_g_cv = pickle.load(handle)
    
with open('./experiment_evaluations/tumor_glosspath_tuning_hallmark_oct8_2024.pickle', 'rb') as handle:
    hallmark_g_cv = pickle.load(handle)
    
with open('./experiment_evaluations/gloss_lasso_tuning_l_tumor_oct23_2024.pickle', 'rb') as handle:
    lasso_dict = pickle.load(handle)
    
with open('./experiment_evaluations/gloss_elasticnet_tuning_l_tumor_oct23_2024.pickle', 'rb') as handle:
