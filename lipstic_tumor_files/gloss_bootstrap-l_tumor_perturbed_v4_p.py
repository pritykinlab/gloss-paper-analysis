...
datapath = '../joint_notebooks/datasets/{}_lipstic_tumor_data_perturbed_v4_p_oct_25_2024.h5ad'.format(i)
...
savepath = './experiment_evaluations/{}_tumor_perturbed_v4_p_new_gloss_bootstrap_hallmark_oct25_2024.pickle'.format(i)
